...
<article class="center">
    <button class="btn btn-primary creer_pub" id="openerPublication">Nouvel Astuce</button>

    <div id="dialog" title="Nouvelle Publication">


            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#menu2">Astuce</a></li>
            </ul>
                ...
                <div id="menu2" class="tab-pane fade in active">
                    <form data-parsley-validate action="<?php echo path; ?>client/ajouterPublication/<?php echo $data2; ?>" class="parsley_pub" method="post">
                        ...
                        <div class="form-group">
                            <input data-parsley-required="true" data-parsley-required-message="true" name="titre" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Titre">
                        </div>
                        <div class="form-group">
                            <input name="url" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="URL optionnel">
                        </div>
                        <div class="form-group">
                            <textarea data-parsley-required="true" data-parsley-required-message="true" name="publications" class="form-control" id="exampleTextarea"  placeholder="Texte" rows="3"></textarea>
                        </div>
...
<!--                <span class="glyphicon glyphicon-remove" data-id="--><?php //echo $publication->id; ?><!--" style="color:red"></span>-->
                ...
                <img src="<?php echo path; ?>templates/images/lire.png"      width="20" height="20"><a class="afficher droite pointeur" style="font-size:9pt; color:#7C3840;" data-id="<?php echo $publication->id ?>">Lire</a>
                <img src="<?php echo path; ?>templates/images/evaluer.png"   width="20" height="20"><a class="evaluer  droite pointeur" style="font-size:9pt; color:#7C3840;" data-id="<?php echo $publication->id ?>">Évaluer</a>
                <img src="<?php echo path; ?>templates/images/supprimer.png" width="20" height="20"><a class="supprimer   pointeur" style="font-size:9pt; color:#7C3840;" data-id="<?php echo $publication->id ?>">Supprimer</a>
